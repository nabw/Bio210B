...
\newpage
\section*{Parte 3}
Este código fue visto en clases como ejemplo del ciclo \code{while}: 
...
Entregue el detalle de todo lo que falta para que este código se pueda ejecutar y que cumpla con su objetivo. 
