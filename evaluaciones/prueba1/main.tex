...
Responda las siguientes preguntas de alternativas. Cada pregunta correcta vale X puntos. 
    ...
    \begin{enumerate}
        ...
        \item Elija el comando que sirve para ver los contenidos de un archivo de text
...
Escriba la salida obtenida al ejecutar los siguientes comandos, considerando la variable \code{d = [1,3,5]}: 
    \begin{enumerate}
        ...
        \item generarDatos(d)["datos"]
        \item generarDatos(d)["promedio"]
        \item generarDatos(d)["varianza"]
    \end{enumerate}
\newpage
Desarrollo Parte 2: 
...
Este código actualmente no está completo, por lo que no se podría ejecutar. Entregue el detalle de todo lo que falta para que este código se pueda ejecutar y que cumpla con su objetivo. 
