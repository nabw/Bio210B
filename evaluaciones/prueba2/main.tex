...
Considere la carpeta 'home' estructurada de la siguiente manera: 
    ...
    \end{Large}}
    \end{center}
Suponga que los módulos hola,m1,m11,m21 contienen las siguientes funciones:
    \begin{itemize}
        \item leer.py:
            \begin{minted}{python}
    ...
    def procesar_datos(datos,salida):
        ...
        """
            \end{minted}
    \end{itemize}
    Escriba los contenidos de la función de manera que cumpla con los siguientes requisitos: 
    \begin{enumerate}
        ...
        \item Que combine los archivos 'd1.xls' y 'd2.xls' en un único archivo 'd.xls' que sea guardado en la carpeta 'resultados/datos'.
        \item Que lo primero que muestre el archivo sea el saludo entregado por el módulo 'hola'.
...
Escriba un script en Python que realice lo siguiente:
    \begin{itemize}
        \item Tiene que cargar los datos del archivo 'csv' en dos listas separadas, una para 'x' y otra para 'y'.
        \item Debe graficar los datos considerando que 'y' es una función de 'x'.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Consid2re una clase 'Vec3D' que genera el siguiente mensaje de ayuda:
    \begin{minted}{bash}
...
class Vec3D(builtins.object)
 ...
 |      y la entrega.
    ...
    \end{minted}
Escriba una clase 'Vec3D' que genere el mensaje de ayuda mostrado, y además implemente las funciones \texttt{\_\_init\_\_}, \texttt{\_\_add\_\_}, y \texttt{norm}. Dejamos como referencia que la norma de un vector $\vec X = (x,y,z)$ se define de la siguiente manera:
...
En un cierto repositorio, existe un archivo \texttt{cumple.txt} donde están registrados los cumpleaños de todas las personas involucradas en el proyecto. En una cierta línea aparece el de su amigo José:
    ...
    \begin{verbatim}
        ...
        ...
    \end{verbatim}
pero Ud. sabe que el cumpleaños de de José es el 4 de mayo. Sabiendo que Ud. tiene acceso al repositorio y asumiendo que la dirección SSH del repositorio es \texttt{git@github.com:empresa/software-empresa.git}, explique cómo arreglaría este archivo en el repositorio online. Para su respuesta, muestre el detalle completo de los comandos de git, pero no es necesario que muestre los comandos que usaría para editar archivos (basta que escriba "modificar el archivo en la línea X y escribir Y"). 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document}
