...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}\frametitle{Ranking de lenguajes (TIOBE Ranking 2026)}
    \begin{enumerate}
        \item Python  (21.81\%)
        \item C  (11.05\%)
        \item C++ (8.55 \%)
        \item Java (8.12 \%)
        \item C\# (6.83 \%)
        \item Javascript (2.92 \%)
        \item Visual Basic (2.85 \%)
        \item R (2.19\%)
        \item SQL (1.93\%)
        \item Delphi / Object Pascal (1.88\%)
    \end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Python}
...
\begin{frame}\frametitle{Datos sobre Python}
    \begin{itemize}
        ...
        \item Creado en 1991 por Guido van Rossum (en navidad...)
        \item Basado en C
